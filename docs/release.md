...
Its runner_source table pins the exact source commit and SHA-256.
`scripts/release.py` is an unchanged copy of that commit's bundled runner,
including the upstream URL attribution added after `release-skills v1.0.1`.
